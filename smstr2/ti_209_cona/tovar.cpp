#include <bits/stdc++.h> // лечше не включать все библиотеки, компиляция будет дольше
#include "tovar.h"
...
{
	if (!novii_massiv)
	{ // должен быть while, либо выходить из функции при неудачном выделении
